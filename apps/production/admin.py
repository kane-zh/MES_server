...
admin.site.register(ProductDataTypeDefinitionModel)
admin.site.register(ProductDataDefinitionModel)
admin.site.register(SemifinishedDataTypeDefinitionModel)
admin.site.register(SemifinishedDataDefinitionModel)
