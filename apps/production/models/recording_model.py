...
class ProductDataDefinitionModel(models.Model):
    ...
    stationType_code = models.CharField(max_length=32,null=True, blank=True, name="stationType_code", verbose_name="工位类型编码", help_text="当前工位类型编码")
    stationType_name = models.CharField(max_length=32, null=True, blank=True,name="stationType_name", verbose_name="工位类型名称",help_text="当前工位类型名称")
    station_id = models.CharField(max_length=16,null=True, blank=True, name="station_id", verbose_name="工位id", help_text="当前工位id")
    station_code = models.CharField(max_length=32,null=True, blank=True, name="station_code", verbose_name="工位编码", help_text="当前工位编码")
    station_name = models.CharField(max_length=32, null=True, blank=True,name="station_name", verbose_name="工位名称", help_text="当前工位名称")
    handler = models.CharField(max_length=32,null=True, blank=True,name="handler", verbose_name="操作者", help_text="对当前信息进行操作的是谁")
    sum = models.IntegerField( name="sum", null=True, blank=True,verbose_name="操作数量",help_text="当前操作的数量是")
...
class ProductStationReportModel(models.Model):
    ...
    """
    id = models.AutoField(primary_key=True, unique=True)
    taskType_code = models.CharField(max_length=32, null=True, blank=True,name="taskType_code", verbose_name="任务类型编码", help_text="当前任务类型编码")
    taskType_name = models.CharField(max_length=32,null=True, blank=True, name="taskType_name", verbose_name="任务类型名称",help_text="当前任务类型名称")
    task_id = models.CharField(max_length=16,null=True, blank=True, name="task_id", verbose_name="任务id", help_text="当前任务id")
    task_code = models.CharField(max_length=32,null=True, blank=True, name="task_code", verbose_name="任务编码", help_text="当前任务编码")
    task_name = models.CharField(max_length=32, null=True, blank=True,name="task_name", verbose_name="任务名称",help_text="当前任务名称")
    productType_code = models.CharField(max_length=32, null=True, blank=True,name="productType_code", verbose_name="产品类型编码", help_text="当前物品的产品类型编码")
    productType_name = models.CharField(max_length=32,null=True, blank=True, name="productType_name", verbose_name="产品类型名称",help_text="当前物品的产品类型名称")
    product_id = models.CharField(max_length=16, null=True, blank=True,name="product_id", verbose_name="产品id", help_text="当前物品的产品id")
    product_code = models.CharField(max_length=32,null=True, blank=True, name="product_code", verbose_name="产品编码", help_text="当前物品的产品编码")
    product_name = models.CharField(max_length=32, null=True, blank=True,name="product_name", verbose_name="产品名称",help_text="当前物品的产品名称")
    stationType_code = models.CharField(max_length=32, null=True, blank=True,name="stationType_code", verbose_name="工位类型编码", help_text="当前工位类型编码")
    stationType_name = models.CharField(max_length=32, null=True, blank=True,name="stationType_name", verbose_name="工位类型名称",help_text="当前工位类型名称")
    station_id = models.CharField(max_length=16, null=True, blank=True,name="station_id", verbose_name="工位id", help_text="当前工位id")
    station_code = models.CharField(max_length=32,null=True, blank=True, name="station_code", verbose_name="工位编码", help_text="当前工位编码")
    ...
    sum = models.IntegerField( name="sum", null=True, blank=True,verbose_name="库存数量", help_text="当前产品的库存数量")
...
class SemifinishedStationReportModel(models.Model):
    ...
    task_code = models.CharField(max_length=32, null=True, blank=True,name="task_code", verbose_name="任务编码", help_text="当前任务编码")
    task_name = models.CharField(max_length=32, null=True, blank=True,name="task_name", verbose_name="任务名称",help_text="当前任务名称")
    semifinishedType_code = models.CharField(max_length=32,null=True, blank=True, name="semifinishedType_code", verbose_name="半成品类型编码", help_text="当前物品的半成品类型编码")
    semifinishedType_name = models.CharField(max_length=32, null=True, blank=True,name="semifinishedType_name", verbose_name="半成品类型名称",help_text="当前物品的半成品类型名称")
    semifinished_id = models.CharField(max_length=16,null=True, blank=True, name="semifinished_id", verbose_name="半成品id", help_text="当前物品的半成品id")
    semifinished_code = models.CharField(max_length=32,null=True, blank=True, name="semifinished_code", verbose_name="半成品编码", help_text="当前物品的半成品编码")
    semifinished_name = models.CharField(max_length=32, null=True, blank=True,name="semifinished_name", verbose_name="半成品名称",help_text="当前物品的半成品名称")
    ...
    station_code = models.CharField(max_length=32, null=True, blank=True,name="station_code", verbose_name="工位编码", help_text="当前工位编码")
    station_name = models.CharField(max_length=32, null=True, blank=True,name="station_name", verbose_name="工位名称",help_text="当前工位名称")
    sum = models.IntegerField( name="sum", null=True, blank=True,verbose_name="库存数量", help_text="当前半成品的库存数量")
    attribute1 = models.CharField(max_length=32, null=True, blank=True, name="attribute1", verbose_name="属性1", help_text="当前附加属性1")
    attribute2 = models.CharField(max_length=32, null=True, blank=True, name="attribute2", verbose_name="属性2", help_text="当前附加属性2")
    attribute3 = models.CharField(max_length=32, null=True, blank=True, name="attribute3", verbose_name="属性3", help_text="当前附加属性3")
    attribute4 = models.CharField(max_length=32, null=True, blank=True, name="attribute4", verbose_name="属性4", help_text="当前附加属性4")
