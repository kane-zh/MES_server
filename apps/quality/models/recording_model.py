...
class InspectionRecordItemModel(models.Model):
    """
    检验记录子项
    """
    ...
    class Meta:
        db_table = "InspectionRecordItemModel"
        app_label = 'quality'
        verbose_name = "品质管理－检验记录子项"
...
class InspectionRecordModel(models.Model):
    ...
    id = models.AutoField(primary_key=True, unique=True)
    name = models.CharField(max_length=32, name="name", null=True, blank=True, verbose_name="名称",help_text="检验记录名称(建议唯一)")
    code = models.CharField(max_length=32, name="code",null=True, blank=True,  verbose_name="编码", help_text="检验记录编码(与类型联合唯一)")
    type = models.ForeignKey(InspectionRecordTypeDefinitionModel, on_delete=models.CASCADE,name="type",
                             related_name="inspectionRecordType_item",verbose_name="类型", help_text="当前检验记录属于的检验记录类型")
    state = models.CharField(max_length=16,choices=STATUS, default="新建", name="state", verbose_name="状态", help_text="当前信息的状态")
    child = models.ManyToManyField(InspectionRecordItemModel, blank=True, name="child", verbose_name="检验记录子项",
                                    help_text="当前检验记录子项")
    ...
    attribute1 = models.CharField(max_length=32, null=True, blank=True, name="attribute1", verbose_name="属性1", help_text="当前检验记录附加的属性1")
    attribute2 = models.CharField(max_length=32, null=True, blank=True, name="attribute2", verbose_name="属性2", help_text="当前检验记录附加的属性2")
    attribute3 = models.CharField(max_length=32, null=True, blank=True, name="attribute3", verbose_name="属性3", help_text="当前检验记录附加的属性3")
    attribute4 = models.CharField(max_length=32, null=True, blank=True, name="attribute4", verbose_name="属性4", help_text="当前检验记录附加的属性4")
    attribute5 = models.CharField(max_length=32, null=True, blank=True, name="attribute5", verbose_name="属性5", help_text="当前检验记录附加的属性5")
    image = models.ManyToManyField(QualityImageModel, blank=True, name="image", verbose_name="照片", help_text="当前记录项的照片信息")
    file = models.ManyToManyField(QualityFileModel, blank=True, name="file", verbose_name="文件", help_text="当前检验记录的文件信息")
    ...
    class Meta:
        db_table = "InspectionRecordModel"
        app_label = 'quality'
        verbose_name = "品质管理－检验记录"
        verbose_name_plural = verbose_name
        permissions = {("read_inspectionrecordmodel", u"Can read 品质管理－检验记录"),
                       ("admin_inspectionrecordmodel", u"Can admin 品质管理－检验记录")}