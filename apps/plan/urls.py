...
router.register('productTaskType', ProductTaskTypeView, basename= "ProductTaskTypeView")
router.register('productTaskTypes', ProductTaskTypeViews, basename= "ProductTaskTypeViews")
...
router.register('semifinishedTaskType', SemifinishedTaskTypeView, basename= "SemifinishedTaskTypeView")
router.register('semifinishedTaskTypes', SemifinishedTaskTypeViews, basename= "SemifinishedTaskTypeViews")
